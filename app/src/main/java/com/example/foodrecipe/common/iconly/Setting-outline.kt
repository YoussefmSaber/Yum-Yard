...
val Iconly.`Setting-outline`: ImageVector
    get() {
        if (`_setting-outline` != null) {
            return `_setting-outline`!!
        }
        `_setting-outline` = Builder(name = "Setting-outline", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF797979)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(15.0f, 22.19f, 14.79f, 22.16f, 14.58f, 22.11f)
                curveTo(13.96f, 21.94f, 13.44f, 21.55f, 13.11f, 21.0f)
                lineTo(12.99f, 20.8f)
                curveTo(12.4f, 19.78f, 11.59f, 19.78f, 11.0f, 20.8f)
                ...
                curveTo(19.53f, 15.54f, 19.1f, 15.71f, 18.93f, 16.0f)
                ...
                curveTo(17.23f, 17.01f, 17.16f, 16.0f, 17.6f, 15.23f)
                ...
                curveTo(6.0f, 5.43f, 6.04f, 5.74f, 6.19f, 6.0f)
                ...
                curveTo(6.83f, 16.01f, 6.76f, 17.02f, 6.19f, 18.0f)
                curveTo(6.04f, 18.26f, 6.0f, 18.57f, 6.08f, 18.87f)
                ...
                lineTo(9.71f, 20.04f)
                curveTo(10.28f, 19.06f, 11.11f, 18.49f, 12.0f, 18.49f)
                close()
            }
        }
        .build()
...
private var `_setting-outline`: ImageVector? = null
