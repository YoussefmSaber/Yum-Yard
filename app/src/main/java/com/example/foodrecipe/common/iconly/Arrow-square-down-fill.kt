...
val Iconly.`Arrow-square-down-fill`: ImageVector
    get() {
        if (`_arrow-square-down-fill` != null) {
            return `_arrow-square-down-fill`!!
        }
        `_arrow-square-down-fill` = Builder(name = "Arrow-square-down-fill", defaultWidth = 24.0.dp,
...
private var `_arrow-square-down-fill`: ImageVector? = null
