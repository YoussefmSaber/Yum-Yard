...
val Iconly.`Document-text-outline`: ImageVector
    get() {
        if (`_document-text-outline` != null) {
            return `_document-text-outline`!!
        }
        `_document-text-outline` = Builder(name = "Document-text-outline", defaultWidth = 24.0.dp,
...
private var `_document-text-outline`: ImageVector? = null
