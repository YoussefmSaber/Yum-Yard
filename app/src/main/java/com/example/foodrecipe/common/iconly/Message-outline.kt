...
val Iconly.`Message-outline`: ImageVector
    get() {
        if (`_message-outline` != null) {
            return `_message-outline`!!
        }
        `_message-outline` = Builder(name = "Message-outline", defaultWidth = 24.0.dp, defaultHeight
...
private var `_message-outline`: ImageVector? = null
