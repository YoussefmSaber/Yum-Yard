...
val Iconly.`Document-favorite-outline`: ImageVector
    get() {
        if (`_document-favorite-outline` != null) {
            return `_document-favorite-outline`!!
        }
        `_document-favorite-outline` = Builder(name = "Document-favorite-outline", defaultWidth =
...
private var `_document-favorite-outline`: ImageVector? = null
