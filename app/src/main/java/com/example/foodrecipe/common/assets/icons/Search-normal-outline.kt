...
val Iconly.`Search-normal-outline`: ImageVector
    get() {
        if (`_search-normal-outline` != null) {
            return `_search-normal-outline`!!
        }
        `_search-normal-outline` = Builder(name = "Search-normal-outline", defaultWidth = 24.0.dp,
...
private var `_search-normal-outline`: ImageVector? = null
